...
if __name__ == "__main__":
    ...
    # dynamicallyclassifier adjustment
    ...
    model_with_removed_layer = VGG11()
    model_with_removed_layer.features = nn.Sequential(*list(model_with_removed_layer.features.children())[:-3])  # Remove last layers
    model_with_removed_layer._rebuild_classifier()  # Rebuild classifier dynamically
    train_and_evaluate(model_with_removed_layer, trainloader, testloader)
